...
interface SolMetaplexTokenJSON {
...
interface SolMetaplexTokenInput {
    readonly metadataUri: string;
    readonly masterEdition: boolean;
    readonly isMutable: boolean;
    readonly primarySaleHappened: number;
...
declare class SolMetaplexToken {
    static create(input: SolMetaplexTokenInput | SolMetaplexToken): SolMetaplexToken;
    static fromJSON(json: SolMetaplexTokenJSON): SolMetaplexToken;
    readonly metadataUri: string;
    readonly masterEdition: boolean;
    readonly isMutable: boolean;
    readonly primarySaleHappened: number;
...
interface SolTokenMetadataInput {
    readonly mint: string;
    readonly standard: string;
    readonly name: string;
    readonly symbol: string;
...
declare class SolTokenMetadata {
    static create(input: SolTokenMetadataInput | SolTokenMetadata): SolTokenMetadata;
    static fromJSON(json: SolTokenMetadataJSON): SolTokenMetadata;
    readonly mint: string;
    readonly standard: string;
    readonly name: string;
    readonly symbol: string;
    readonly metaplex: SolMetaplexToken;
    private constructor();
    toJSON(): SolTokenMetadataJSON;
}

interface GetTokenMetadataOperationRequest {
    /**
     * @description The network to query
     */
    readonly network: SolNetworkInput | SolNetwork;
...
interface GetTokenMetadataOperationRequestJSON {
    readonly network: SolNetworkJSON;
    readonly address: SolAddressJSON;
}
type GetTokenMetadataOperationResponse = SolTokenMetadata;
type GetTokenMetadataOperationResponseJSON = SolTokenMetadataJSON;
declare const GetTokenMetadataOperation: {
    operationId: string;
    groupName: string;
    httpMethod: string;
    routePattern: string;
...
type SolGetTokenMetadataNetworkEnumJSON = "mainnet" | "devnet";
type SolGetTokenMetadataNetworkEnumInput = "mainnet" | "devnet";
type SolGetTokenMetadataNetworkEnumValue = "mainnet" | "devnet";
declare abstract class SolGetTokenMetadataNetworkEnum {
    static create(input: SolGetTokenMetadataNetworkEnumInput | SolGetTokenMetadataNetworkEnumValue): SolGetTokenMetadataNetworkEnumValue;
    static fromJSON(json: SolGetTokenMetadataNetworkEnumJSON): SolGetTokenMetadataNetworkEnumValue;
}
...
export { CommonSolUtils, CommonSolUtilsConfig, CommonSolUtilsConfigSetup, GetBalanceJSONRequest, GetBalanceJSONResponse, GetBalanceRequest, GetBalanceResponse, GetBalanceResponseAdapter, GetNFTMetadataJSONRequest, GetNFTMetadataJSONResponse, GetNFTMetadataRequest, GetNFTMetadataResponse, GetNFTMetadataResponseAdapter, GetNFTsJSONRequest, GetNFTsJSONResponse, GetNFTsRequest, GetNFTsResponse, GetNFTsResponseAdapter, GetPortfolioJSONRequest, GetPortfolioJSONResponse, GetPortfolioRequest, GetPortfolioResponse, GetPortfolioResponseAdapter, GetSPLJSONRequest, GetSPLJSONResponse, GetSPLRequest, GetSPLResponse, GetSPLResponseAdapter, GetTokenMetadataOperation, GetTokenMetadataOperationRequest, GetTokenMetadataOperationRequestJSON, GetTokenMetadataOperationResponse, GetTokenMetadataOperationResponseJSON, GetTokenPriceJSONRequest, GetTokenPriceJSONResponse, GetTokenPriceOperation, GetTokenPriceOperationRequest, GetTokenPriceOperationRequestJSON, GetTokenPriceOperationResponse, GetTokenPriceOperationResponseJSON, GetTokenPriceRequest, GetTokenPriceResponse, GetTokenPriceResponseAdapter, SolAddress, SolAddressInput, SolAddressJSON, SolAddressish, SolGetTokenMetadataNetworkEnum, SolGetTokenMetadataNetworkEnumInput, SolGetTokenMetadataNetworkEnumJSON, SolGetTokenMetadataNetworkEnumValue, SolGetTokenPriceNetworkEnum, SolGetTokenPriceNetworkEnumInput, SolGetTokenPriceNetworkEnumJSON, SolGetTokenPriceNetworkEnumValue, SolMetaplexToken, SolMetaplexTokenInput, SolMetaplexTokenJSON, SolNative, SolNativeInput, SolNativeJSON, SolNativeUnit, SolNativeish, SolNetwork, SolNetworkInput, SolNetworkJSON, SolNetworkName, SolNetworkResolver, SolNetworkish, SolSPLNativePrice, SolSPLNativePriceInput, SolSPLNativePriceJSON, SolSPLTokenPrice, SolSPLTokenPriceInput, SolSPLTokenPriceJSON, SolTokenMetadata, SolTokenMetadataInput, SolTokenMetadataJSON, getBalanceOperation, getNFTMetadataOperation, getNFTsOperation, getPortfolioOperation, getSPLOperation, getTokenPriceOperation, operations$1 as operations, operationsV2, operationsV2All };
