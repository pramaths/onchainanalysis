    ...
    function ClientEvmApi() {
        ...
        _this.defi = {
            ...
            getPairPrice: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetPairPriceOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
        };
        _this.token = {
            ...
            getMultipleTokenPrices: function (request, body) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetMultipleTokenPricesOperation, _this.baseUrl, _this.core).fetch(request, body);
            },
        ...
        _this.resolve = {
            ...
            resolveAddressToDomain: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.ResolveAddressToDomainOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
        };
        _this.utils = {
        ...
        _this.wallets = {
            getWalletTokenBalancesPrice: function (request) {
                return new apiUtils.PaginatedOperationV3Resolver(commonEvmUtils.GetWalletTokenBalancesPriceOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
            getWalletNetWorth: function (request) {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetWalletNetWorthOperation, _this.baseUrl, _this.core).fetch(request, null);
            },
        ...
        _this.marketData = {
            ...
            getTopCryptoCurrenciesByMarketCap: function () {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetTopCryptoCurrenciesByMarketCapOperation, _this.baseUrl, _this.core).fetch({}, null);
            },
            getTopCryptoCurrenciesByTradingVolume: function () {
                return new apiUtils.OperationV3Resolver(commonEvmUtils.GetTopCryptoCurrenciesByTradingVolumeOperation, _this.baseUrl, _this.core).fetch({}, null);
            },
        };
        return _this;
    }
