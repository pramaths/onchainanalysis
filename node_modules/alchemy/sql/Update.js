...
module.exports = require('./defineStatement')('udate', {
	...
	toString: function(){
		...
		return 'UPDATE ' + target + ' SET ' + cols + ' VALUES ' + values + ';'
	},
	...
	valuesToString: function(){
		...
		return this.values.map(function(values){
			...
			var result = cols.map(function(colName){
				return this.valueToString(values[colName])
			}, this)
