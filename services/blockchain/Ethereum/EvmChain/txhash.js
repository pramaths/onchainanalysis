const { txHash } = require('./endpoint_functions');
...
const txHashdetails = async (req, res) => {
    try {
        const { txhash } = req.params;
        console.log(`Fetching normal transactions for txhash: ${txhash}`);
        ...
        try {
            ...
            response = await txHash(providerConfig,txhash);
        } catch (error) {
